...
public class LinearSolver {
	...
	public static LinearSolution DualSimplex(RealMatrix canonical) {
		...
		while(pivotRowNum >= 0) {
			...
			if (problem) { // PANIC
				//JOptionPane.showMessageDialog(this, "A bad thing happened during Dual Simplex.", "Error", JOptionPane.WARNING_MESSAGE);
				System.err.println("A bad thing happened during Dual Simplex");
				return null;
			}
